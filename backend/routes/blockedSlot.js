...
router.post('/', createLimiter, auth, authorize(['entrevistador', 'admin']), createBlockedSlot);
...
router.delete('/:id', deleteLimiter, auth, validateObjectId('id'), authorize(['entrevistador', 'admin']), deleteBlockedSlot);
